...
namespace :redmine do
  namespace :backlogs do
    task :manage_github_issues => :environment do
      ...
      SUPPORTED = {
        ...
        'platform' => (travis['env'] - travis['matrix']['allow_failures'].to_a.collect{|f| f['env']}).collect{|v|
      ...
      begin
        BacklogRepository.new('backlogs/redmine_backlogs', **config)
      rescue => e
